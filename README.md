...
## 📖 Overview
This repository contains a grid-based ecosystem simulation featuring dynamic weather, soil degradation, and flora/fauna lifecycles. It includes an autonomous exploration robot that traverses the territory to scan entities, manage its battery constraints, and construct a structured environmental knowledge base.
